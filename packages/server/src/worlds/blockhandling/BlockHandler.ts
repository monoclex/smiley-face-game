...
import { ServerBlockBufferPacket, SERVER_BLOCK_BUFFER_ID } from "@smiley-face-game/packets/ServerBlockBuffer";
import { ServerBlockLinePacket, SERVER_BLOCK_LINE_ID } from "@smiley-face-game/packets/ServerBlockLine";
import { ServerBlockSinglePacket, SERVER_BLOCK_SINGLE_ID } from "@smiley-face-game/packets/ServerBlockSingle";
...
export class BlockHandler {
  constructor(public map: WorldBlocks, readonly width: number, readonly height: number) {
